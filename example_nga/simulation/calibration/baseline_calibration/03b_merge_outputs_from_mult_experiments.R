...
sim_output_base_filepath = 'C:/Users/moniqueam/Dropbox (IDM)/NU_collaboration/hbhi_nigeria/snt_2022/simulation_output'

# set source and target filepaths
exp1_filepath = paste0(sim_output_base_filepath, '/transmission_intensity_calibration/PfPR_calibration_main_sweep_NGA_v6_part1')
exp2_filepath = paste0(sim_output_base_filepath, '/transmission_intensity_calibration/PfPR_calibration_main_sweep_NGA_v6_part2')
merged_filepath = paste0(sim_output_base_filepath, '/transmission_intensity_calibration/PfPR_calibration_main_sweep_NGA_v6')
