...
rep_admin = 'Ikot Abasi'  #  'Bindawa' 'Fakai' 'Ikot Abasi' 'Markafi'
...
expname = '%s_NGA_%s_maxHab%d_monthScalar%d_v5' % (scen_df.at[scen_index, 'ScenarioName'], rep_admin, max_habitat_value*1000, month_scalar*1000)
...
month_vals, fractions = get_burnin_spline_values(rep_admin, month_scalar)
