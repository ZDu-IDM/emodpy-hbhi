...
rep_admin = 'Ikot Abasi'  #  'Bindawa' 'Fakai' 'Markafi' 'Ikot Abasi'
# burn-in id should be listed for each of the archetypes
burnin_ids = {
    'Bindawa': '97573c41-a487-ed11-aa00-b88303911bc1',  # w/deomgraphics1000: '149e532d-1372-ed11-aa00-b88303911bc1', # w/drugIP: '6b941b13-dd70-ed11-a9ff-b88303911bc1',  # w/climate: 'caf7bdc3-a66f-ed11-a9ff-b88303911bc1',
    'Fakai': '366c3e4e-a487-ed11-aa00-b88303911bc1',  # w/deomgraphics1000: '189e532d-1372-ed11-aa00-b88303911bc1', # w/drugIP: '9a718b25-dd70-ed11-a9ff-b88303911bc1',  # w/climate:'b08ec6bd-a66f-ed11-a9ff-b88303911bc1',
    'Ikot Abasi': 'd0311274-a487-ed11-aa00-b88303911bc1',  # w/deomgraphics1000: 'a4662a3d-1372-ed11-aa00-b88303911bc1', # w/drugIP: 'db69c12b-dd70-ed11-a9ff-b88303911bc1',  # w/climate:'6d338eb7-a66f-ed11-a9ff-b88303911bc1',
    'Markafi': '5ee7383b-a487-ed11-aa00-b88303911bc1',  # w/deomgraphics1000: 'fb862943-1372-ed11-aa00-b88303911bc1', # w/drugIP: '046ac12b-dd70-ed11-a9ff-b88303911bc1',  # w/climate:'854d8ab1-a66f-ed11-a9ff-b88303911bc1',
}
# set whether this is the first or second set of calibrations for this archetype
round_number = 3  # <-- user needs to specify which round this is to pick up from prior round
if round_number > 1:
...
if pull_from_serialization:
    ...
    burnin_years = 50  # year when serialization occurred in burnin
...
# scen_index = scen_df[scen_df['ScenarioName'] == 'seasonality_calibration'].index[0]
expname = '%s_%s_NGA2019_v6_round%i_maxInc%i' % (scen_df.at[scen_index, 'ScenarioName'], rep_admin, round_number,max_incidence)
...
sim_runs_per_param_set = 10  # 15
sim_runs_per_param_set_second = 10
sim_runs_per_param_set_fourth = 10  # 30
max_iterations = 10
max_iterations_second = 20
max_iterations_fourth = 20  #!! 20
samples_per_iteration = 40  # must be at least 2
...
if later_round:
    round1_fname = os.path.join('%s_%s_NGA2019_v6_round%i_maxInc%i' % (scen_df.at[scen_index, 'ScenarioName'], rep_admin, (round_number-1), max_incidence), '_plots', 'LL_all.csv')
...
optimtool = OptimTool(params,
                      ...
                      sigma_r=r/10.,  #!!/2.,    # <-- stdev of radius
