...
num_burnin_seeds = 1  # number of seeds run during previous burnin and habitat multiplier calibration
ser_date = 50*365
...
if population_size == 6000:  # generated from serialize_transmission_sweep (1960-2010)
    burnin_id = 'bc32ec7f-d3e2-ed11-aa05-b88303911bc1'
else:
