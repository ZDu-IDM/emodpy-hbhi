...
if(country_name =='BurkinaFaso'){
  box_filepath = 'C:/Users/moniqueam/Box'
  ...
  box_filepath = 'C:/Users/moniqueam/Dropbox (IDM)/Malaria Team Folder/projects'
  ...
  box_filepath = 'C:/Users/moniqueam/Dropbox (IDM)/Malaria Team Folder/projects'
  hbhi_dir = paste0(box_filepath, '/burundi_hbhi/snt_2023')
  ...
  # output filenames
  ento_output_filepath = paste(hbhi_dir, '/ento', sep='')
  ds_pop_df_filename = paste(pop_raster_filepath, '/input_layers/populationDS/population_size_each_DS_from_FB.csv', sep='')
...
if(!file.exists(paste0(ento_output_filepath, '/DS_vector_rel_abundance.csv'))){
  ...
  create_admin_relVectAbundance_csv_from_raster(base_filepath_raster=base_filepath_raster, ds_shapefile_filepath=ds_shapefile_filepath, shp_ds_name=shp_ds_name, ento_output_filepath=ento_output_filepath)
}
