...
if(country =='BDI'){
  dta_dir = 'C:/Users/moniqueam/Dropbox (IDM)/Malaria Team Folder/data/Burundi/DHS'
  # read in shapefile with admin boundaries
  shapefile_filepath = 'C:/Users/moniqueam/Dropbox (IDM)/Malaria Team Folder/projects/burundi_hbhi/shapefiles_rasterfiles/bdi_adm_igebu_ocha/bdi_admbnda_adm2_igebu_ocha_20171103.shp'
  admin_shape = shapefile(shapefile_filepath)

  dhs_years = c(2010, 2012, 2016)
  dhs_year_dirs = c('BU_2010_DHS', 'BU_2012_MIS', 'BU_201617_DHS')
...
house_filenum = 5 # 2010:, 2012:, 2016:
...
# individual codes
ind_codes = c('caseid','bidx','v001','v012','v014','v006','v007','v105', 'hw16', 'h32z','h47','m49a', 'ml1', 'h3', 'h5', 'h7', 'h9', 'm14', art_codes, non_art_codes)
ind_filenum = 6 # 2010:, 2012:, 2016: 6
...
(sum(dta_list[[6]][,'m14']>0, na.rm=TRUE) - sum(dta_list[[6]][,'m14']>7, na.rm=TRUE)) / (sum(dta_list[[6]][,'m14']==0, na.rm=TRUE) + sum(dta_list[[6]][,'m14']>0, na.rm=TRUE) - sum(dta_list[[6]][,'m14']>7, na.rm=TRUE) )


###################################
# where individual received net
###################################
#  'HML22' <-- received through ANC or immunization visit
