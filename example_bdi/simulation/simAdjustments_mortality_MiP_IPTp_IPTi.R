...
if(country_name =='Burundi'){
  ...
  if(LLIN_2year){
    ...
    sim_output_base_filepath_2010_allInter = paste0(hbhi_dir, '/simulation_output/simulations_to_present/BDI_toPresent_allInter_v6')
  }
  if(to_present_flag){
    first_year = 2010
    last_year = 2021
  ...
  # hbhi_dir = paste(user_path, '/Box/NU-malaria-team/projects/hbhi_nigeria', sep='')
  # # filepath for simulation output
  # sim_output_filepath = paste(hbhi_dir, '/simulation_output/2020_to_2030_v3', sep='')
  # sim_output_base_filepath_2010_allInter = paste(hbhi_dir, '/simulation_output/2010_to_2020_v10/NGA 2010-20 burnin_hs+itn+smc', sep='')
...
script_base_filepath = paste(user_path, '/Documents/malaria-snt-core/simulation/IPTp_mortality_postprocessing', sep='')
####################################################################################################################################################
...
for(i_scen in 1:length(scenario_adjustment_info$ScenarioName)){
  ...
  admin_subset_flag1 = FALSE
  admin_subset_flag2 = FALSE
  ...
  if('only_run_admin_subset' %in% colnames(scenario_adjustment_info)){
    admin_subset_flag2 = scenario_adjustment_info$only_run_admin_subset[i_scen]
  }
  admin_subset_flag = admin_subset_flag1 | admin_subset_flag2
