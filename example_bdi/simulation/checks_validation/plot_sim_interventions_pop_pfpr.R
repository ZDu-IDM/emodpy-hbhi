...
json_download_filepath = "C:/Users/mambrose/Dropbox (IDM)/Malaria Team Folder/projects/burundi_hbhi/simulation_output/json_download"
cur_sim_folder = 'transCalib_burnin_v2'
cur_sim_folder = 'transCalib_main_Bubanza_v2'
cur_sim_folder = 'transCalib_main_Kiremba'
cur_sim_folder = 'seasonCalib_burnin_v2'
cur_sim_folder = 'seasonCalib_main_v2'
cur_sim_folder = 'toPresent_Bubanza0'
cur_sim_folder = 'toPresent_Bubanza0_no2020Camp'
# cur_sim_folder = 'projection_pyr64_Bubanza0'
...
create_sim_checking_plots = function(json_download_filepath, cur_sim_folder){
 ...
 # human and vector population sizes, climate, PfPR, clinical cases, etc.
  ...
  # interventions delivered and used
  if('Bednet_Got_New_One' %in% names(events$Channels)) plot(seq(events$Header$Start_Time, events$Header$Timesteps-1, by=events$Header$Simulation_Timestep), events$Channels$Bednet_Got_New_One$Data, xlab='simulation day', ylab='number of events', bty='L', main='received new bednet', type='l')
