...
scen_index = scen_df[scen_df['ScenarioName'] == 'seasonality_calibration_burnin_noMassITN'].index[0]
expname = '%s_BDI_%s_maxHab%d_monthScalar%d_v1' % (scen_df.at[scen_index, 'ScenarioName'], rep_admin, max_habitat_value*1000, month_scalar*1000)
